...
There are many things that are strange to when I have to work in Python the first in that the syntax looks like someone from base r tried to port everything to Python and unfortunately suceeded... this creates some strange patterns like the whole iloc vs loc vs [[]] debate, they all suck and I firmly believe that 2d manipulation of data was a mistake, a mistake that Python chose to copy.
